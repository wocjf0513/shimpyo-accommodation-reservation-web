...
public record CartCreateRequest(@NotNull Long roomId,
                                ...
                                @Pattern(regexp = DateUtil.LOCAL_DATE_REGEX_PATTERN, message = "잘못된 시간 형식입니다. (올바른 예시: 2023-10-25)") String startDate,
                                @Pattern(regexp = DateUtil.LOCAL_DATE_REGEX_PATTERN, message = "잘못된 시간 형식입니다. (올바른 예시: 2023-10-25)") String endDate,
                                @NotNull
                                Long price) {
